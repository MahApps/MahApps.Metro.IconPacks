...
namespace MahApps.Metro.IconPacks
{
    ...
    public class RemixIconCursorExtension : RemixIconImageExtension, IPackIconCursorExtension
    {
        public RemixIconCursorExtension() : base() => base.Brush = PackIconCursorHelper.DefaultBrush;
        public RemixIconCursorExtension(PackIconRemixIconKind kind) : base(kind) => base.Brush = PackIconCursorHelper.DefaultBrush;
