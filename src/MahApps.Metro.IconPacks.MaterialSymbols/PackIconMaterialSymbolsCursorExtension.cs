...
namespace MahApps.Metro.IconPacks
{
    ...
    public class MaterialSymbolsCursorExtension : MaterialSymbolsImageExtension, IPackIconCursorExtension
    {
        public MaterialSymbolsCursorExtension() : base() => base.Brush = PackIconCursorHelper.DefaultBrush;
        public MaterialSymbolsCursorExtension(PackIconMaterialSymbolsKind kind) : base(kind) => base.Brush = PackIconCursorHelper.DefaultBrush;
