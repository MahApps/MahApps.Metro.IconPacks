...
namespace MahApps.Metro.IconPacks
{
    ...
    public class PathIconMaterialSymbols : PathIconControlBase
    {
        public static readonly DependencyProperty KindProperty
            = DependencyProperty.Register(nameof(Kind), typeof(PackIconMaterialSymbolsKind), typeof(PathIconMaterialSymbols), new PropertyMetadata(default(PackIconMaterialSymbolsKind), KindPropertyChangedCallback));

        private static void KindPropertyChangedCallback(DependencyObject dependencyObject, DependencyPropertyChangedEventArgs e)
        {
            if (e.NewValue != e.OldValue)
            {
                ((PathIconMaterialSymbols)dependencyObject).UpdateData();
            }
        }
        ...
        public PathIconMaterialSymbols()
        {
        }
