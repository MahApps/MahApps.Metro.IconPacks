...
namespace MahApps.Metro.IconPacks
{
    ...
    public class MingCuteIconsCursorExtension : MingCuteIconsImageExtension, IPackIconCursorExtension
    {
        public MingCuteIconsCursorExtension() : base() => base.Brush = PackIconCursorHelper.DefaultBrush;
        public MingCuteIconsCursorExtension(PackIconMingCuteIconsKind kind) : base(kind) => base.Brush = PackIconCursorHelper.DefaultBrush;
