...
namespace MahApps.Metro.IconPacks
{
    ...
    public class MaterialDesignCursorExtension : MaterialDesignImageExtension, IPackIconCursorExtension
    {
        public MaterialDesignCursorExtension() : base() => base.Brush = PackIconCursorHelper.DefaultBrush;
        public MaterialDesignCursorExtension(PackIconMaterialDesignKind kind) : base(kind) => base.Brush = PackIconCursorHelper.DefaultBrush;
