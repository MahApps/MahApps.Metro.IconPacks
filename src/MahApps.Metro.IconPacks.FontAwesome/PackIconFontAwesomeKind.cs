namespace MahApps.Metro.IconPacks
{
    ...
    public enum PackIconFontAwesomeKind
    {
        ...
        [Description("Adn (f170)")] AdnBrands,
        ...
        [Description("Alarm Clock (f34e, alarm, alarm clock, clock, date, late, pending, reminder, sleep, snooze, timer, timestamp, watch)")] AlarmClockRegular,
        [Description("Alarm Clock (f34e, alarm, alarm clock, clock, date, late, pending, reminder, sleep, snooze, timer, timestamp, watch)")] AlarmClockSolid,
        ...
        [Description("Angrycreative (f36e)")] AngrycreativeBrands,
        ...
        [Description("Apper (f371)")] ApperBrands,
        ...
        [Description("App Store Ios (f370)")] AppStoreIosBrands,
        ...
        [Description("Arrow Right Arrow Left (f0ec, arrow, arrows, reciprocate, return, swap, transfer)")] ArrowRightArrowLeftSolid,
        ...
        [Description("Asymmetrik (f372)")] AsymmetrikBrands,
        ...
        [Description("Aws (f375)")] AwsBrands,
        ...
        [Description("Bacterium (e05a, antibiotic, antibody, covid-19, germ, health, organism, sick)")] BacteriumSolid,
        ...
        [Description("Black Tie (f27e, administrator)")] BlackTieBrands,
        ...
        [Description("Bluesky (e671, social network)")] BlueskyBrands,
        [Description("Bluetooth B (f294)")] BluetoothBBrands,
        ...
        [Description("Building Flag (e4d5, building, city, diplomat, embassy, flag, headquarters, united nations)")] BuildingFlagSolid,
        [Description("Building Lock (e4d6, building, city, closed, lock, lockdown, padlock, privacy, quarantine, secure)")] BuildingLockSolid,
        [Description("Building Ngo (e4d7, building, city, non governmental organization, office)")] BuildingNgoSolid,
        ...
        [Description("Buromobelexperte (f37f)")] BuromobelexperteBrands,
        ...
        [Description("Bus Side (e81d, bus, public transportation, transportation, travel, vehicle)")] BusSideSolid,
        ...
        [Description("Camera (f030, image, img, lens, photo, picture, record, shutter, video)")] CameraRegular,
        ...
        [Description("Cash App (e7d4)")] CashAppBrands,
        ...
        [Description("Cc Amazon Pay (f42d)")] CcAmazonPayBrands,
        [Description("Cc Amex (f1f3, amex)")] CcAmexBrands,
        [Description("Cc Apple Pay (f416)")] CcApplePayBrands,
        [Description("Cc Diners Club (f24c)")] CcDinersClubBrands,
        [Description("Cc Discover (f1f2)")] CcDiscoverBrands,
        [Description("Cc Jcb (f24b)")] CcJcbBrands,
        [Description("Cc Mastercard (f1f1)")] CcMastercardBrands,
        [Description("Cc Paypal (f1f4)")] CcPaypalBrands,
        [Description("Cc Stripe (f1f5)")] CcStripeBrands,
        [Description("Cc Visa (f1f0)")] CcVisaBrands,
        ...
        [Description("Charging Station (f5e7, car charger, charge, charging, electric, ev, tesla, vehicle)")] ChargingStationSolid,
        ...
        [Description("Chart Diagram (e695, algorithm, analytics, flow, graph)")] ChartDiagramSolid,
        ...
        [Description("Clipboard List (f46d, cheatsheet, checklist, completed, done, finished, intinerary, ol, schedule, summary, survey, tick, todo, ul, wishlist)")] ClipboardListSolid,
        [Description("Clipboard Question (e4e3, assistance, faq, interview, query, question)")] ClipboardQuestionSolid,
        [Description("Clipboard (f328, clipboard, copy, notepad, notes, paste, record)")] ClipboardRegular,
        [Description("Clipboard (f328, clipboard, copy, notepad, notes, paste, record)")] ClipboardSolid,
        ...
        [Description("Clone (f24d, add, arrange, copy, duplicate, new, paste)")] CloneRegular,
        [Description("Clone (f24d, add, arrange, copy, duplicate, new, paste)")] CloneSolid,
        ...
        [Description("Cloud (f0c2, atmosphere, cloud, fog, overcast, save, upload, weather)")] CloudRegular,
        [Description("Cloudscale (f383)")] CloudscaleBrands,
        ...
        [Description("Codiepie (f284)")] CodiepieBrands,
        ...
        [Description("Comment Nodes (e696, ai, artificial intelligence, cluster, language, model, network, neuronal)")] CommentNodesSolid,
        [Description("Comment (f075, Right Speech Bubble, answer, bubble, chat, commenting, conversation, conversation, discussion, feedback, message, note, notification, sms, speech, talk, talking, texting)")] CommentRegular,
        ...
        [Description("Comment (f075, Right Speech Bubble, answer, bubble, chat, commenting, conversation, conversation, discussion, feedback, message, note, notification, sms, speech, talk, talking, texting)")] CommentSolid,
        [Description("Comments (f086, Two Speech Bubbles, answer, bubble, chat, commenting, conversation, conversation, discussion, feedback, message, note, notification, sms, speech, talk, talking, texting)")] CommentsRegular,
        [Description("Comments (f086, Two Speech Bubbles, answer, bubble, chat, commenting, conversation, conversation, discussion, feedback, message, note, notification, sms, speech, talk, talking, texting)")] CommentsSolid,
        ...
        [Description("Connectdevelop (f20e)")] ConnectdevelopBrands,
        ...
        [Description("Creative Commons By (f4e7)")] CreativeCommonsByBrands,
        [Description("Creative Commons Nc (f4e8)")] CreativeCommonsNcBrands,
        [Description("Creative Commons Nc Eu (f4e9)")] CreativeCommonsNcEuBrands,
        [Description("Creative Commons Nc Jp (f4ea)")] CreativeCommonsNcJpBrands,
        [Description("Creative Commons Nd (f4eb)")] CreativeCommonsNdBrands,
        [Description("Creative Commons Pd Alt (f4ed)")] CreativeCommonsPdAltBrands,
        [Description("Creative Commons Pd (f4ec)")] CreativeCommonsPdBrands,
        [Description("Creative Commons Remix (f4ee)")] CreativeCommonsRemixBrands,
        [Description("Creative Commons Sa (f4ef)")] CreativeCommonsSaBrands,
        [Description("Creative Commons Sampling (f4f0)")] CreativeCommonsSamplingBrands,
        [Description("Creative Commons Sampling Plus (f4f1)")] CreativeCommonsSamplingPlusBrands,
        [Description("Creative Commons Share (f4f2)")] CreativeCommonsShareBrands,
        [Description("Creative Commons Zero (f4f3)")] CreativeCommonsZeroBrands,
        ...
        [Description("Css3 Alt (f38b)")] Css3AltBrands,
        [Description("Css3 (f13c, code)")] Css3Brands,
        [Description("Css (e6a2, rebecca purple)")] CssBrands,
        ...
        [Description("D And D Beyond (f6ca, Dungeons & Dragons, d&d, dnd, fantasy, gaming, tabletop)")] DAndDBeyondBrands,
        [Description("D And D (f38d)")] DAndDBrands,
        [Description("Dart Lang (e693)")] DartLangBrands,
        ...
        [Description("Deploydog (f38e)")] DeploydogBrands,
        ...
        [Description("Digg (f1a6)")] DiggBrands,
        ...
        [Description("Disqus (e7d5)")] DisqusBrands,
        ...
        [Description("Down Left And Up Right To Center (f422, collapse, fullscreen, minimize, move, resize, scale, shrink, size, smaller)")] DownLeftAndUpRightToCenterSolid,
        ...
        [Description("Drupal (f1a9)")] DrupalBrands,
        ...
        [Description("Duolingo (e812)")] DuolingoBrands,
        ...
        [Description("Edge (f282, browser, ie)")] EdgeBrands,
        [Description("Edge Legacy (e078)")] EdgeLegacyBrands,
        ...
        [Description("Eleventy (e7d6, 11ty)")] EleventyBrands,
        ...
        [Description("Empire (f1d1)")] EmpireBrands,
        ...
        [Description("Envira (f299, leaf)")] EnviraBrands,
        ...
        [Description("Expand (f065, arrows, bigger, enlarge, expand, fullscreen, maximize, resize, resize, scale, size, viewfinder)")] ExpandSolid,
        ...
        [Description("File Arrow Down (f56d, archive, document, export, insert, save)")] FileArrowDownSolid,
        ...
        [Description("File Fragment (e697, block, data, partial, piece)")] FileFragmentSolid,
        [Description("File Half Dashed (e698, data, fragment, partial, piece)")] FileHalfDashedSolid,
        ...
        [Description("Files Pinwheel (e69f)")] FilesPinwheelBrands,
        ...
        [Description("First Order Alt (f50a)")] FirstOrderAltBrands,
        ...
        [Description("Flask Vial (e4f3, ampule, beaker, chemicals, chemistry, experiment, experimental, lab, laboratory, labs, liquid, potion, science, test, test tube, vial)")] FlaskVialSolid,
        ...
        [Description("Flutter (e694)")] FlutterBrands,
        ...
        [Description("Fort Awesome Alt (f3a3, castle)")] FortAwesomeAltBrands,
        ...
        [Description("Gg (f260)")] GgBrands,
        [Description("Gg Circle (f261)")] GgCircleBrands,
        ...
        [Description("Github Alt (f113, octocat)")] GithubAltBrands,
        ...
        [Description("Golang (e40f)")] GolangBrands,
        ...
        [Description("Google (f1a0)")] GoogleBrands,
        ...
        [Description("Gratipay (f184, favorite, heart, like, love)")] GratipayBrands,
        ...
        [Description("Gripfire (f3ac)")] GripfireBrands,
        ...
        [Description("Grip (f58d, affordance, app, collection, dashboard, drag, drop, grab, grid, handle, launcher, square)")] GripSolid,
        ...
        [Description("Headphones (f025, audio, earbud, headphone, listen, music, sound, speaker)")] HeadphonesRegular,
        ...
        [Description("Heart (f004, ace, card, favorite, game, heart, heart suit, like, love, relationship, valentine, wishlist)")] HeartRegular,
        [Description("Heart (f004, ace, card, favorite, game, heart, heart suit, like, love, relationship, valentine, wishlist)")] HeartSolid,
        ...
        [Description("Hexagon Nodes Bolt (e69a, LLM, action, ai, artificial intelligence, cluster, graph, language, llm, model, network, neuronal)")] HexagonNodesBoltSolid,
        [Description("Hexagon Nodes (e699, action, ai, artificial intelligence, cluster, graph, language, llm, model, network, neuronal)")] HexagonNodesSolid,
        [Description("Hexagon (f312, Horizontal Black Hexagon, geometry, honeycomb, polygon, shape)")] HexagonSolid,
        ...
        [Description("Hire A Helper (f3b0)")] HireAHelperBrands,
        [Description("Hive (e07f)")] HiveBrands,
        ...
        [Description("House (f015, abode, building, home, house, main, residence)")] HouseRegular,
        ...
        [Description("Html5 (f13b)")] Html5Brands,
        ...
        [Description("Jenkins (f3b6)")] JenkinsBrands,
        ...
        [Description("Joomla (f1aa)")] JoomlaBrands,
        [Description("Js (f3b8)")] JsBrands,
        ...
        [Description("Kakao Talk (e7d7)")] KakaoTalkBrands,
        ...
        [Description("Lastfm (f202)")] LastfmBrands,
        ...
        [Description("Lightbulb (f0eb, bulb, bulb, comic, comic, electric, electric, energy, idea, idea, innovation, inspiration, inspiration, light, light bulb, mechanical)")] LightbulbRegular,
        [Description("Lightbulb (f0eb, bulb, bulb, comic, comic, electric, electric, energy, idea, idea, innovation, inspiration, inspiration, light, light bulb, mechanical)")] LightbulbSolid,
        ...
        [Description("Linktree (e7d8)")] LinktreeBrands,
        ...
        [Description("List Ul (f0ca, bullet, cheatsheet, checklist, completed, done, finished, ol, summary, survey, todo, ul)")] ListUlSolid,
        ...
        [Description("Lumon (e7e2)")] LumonBrands,
        [Description("Lumon Drop (e7e3)")] LumonDropBrands,
        ...
        [Description("Magnifying Glass Chart (e522, analysis, chart, data, graph, intelligence, magnifier, market, revenue)")] MagnifyingGlassChartSolid,
        ...
        [Description("Maximize (f31e, arrows, bigger, enlarge, expand, fullscreen, maximize, resize, resize, scale, size)")] MaximizeSolid,
        [Description("Mdb (f8ca)")] MdbBrands,
        ...
        [Description("Medrt (f3c8)")] MedrtBrands,
        ...
        [Description("Message (f27a, answer, bubble, chat, commenting, conversation, conversation, discussion, feedback, message, note, notification, sms, speech, talk, talking, texting)")] MessageRegular,
        [Description("Message (f27a, answer, bubble, chat, commenting, conversation, conversation, discussion, feedback, message, note, notification, sms, speech, talk, talking, texting)")] MessageSolid,
        [Description("Meta (e49b)")] MetaBrands,
        [Description("Meteor (f753, armageddon, asteroid, comet, shooting star, space)")] MeteorSolid,
        [Description("Microblog (e01a)")] MicroblogBrands,
        ...
        [Description("Mobile Vibrate (e816, android, call, cell, cell phone, device, haptic, mobile, mobile phone, notification, number, phone, screen, telephone, text)")] MobileVibrateSolid,
        ...
        [Description("Node (f419)")] NodeBrands,
        [Description("Node Js (f3d3)")] NodeJsBrands,
        [Description("Non Binary (e807, female, gender, male, nb, queer)")] NonBinarySolid,
        ...
        [Description("Notion (e7d9)")] NotionBrands,
        ...
        [Description("Octagon (f306, octagonal, shape, sign, stop, stop sign)")] OctagonSolid,
        ...
        [Description("Openai (e7cf)")] OpenaiBrands,
        ...
        [Description("Osi (f41a)")] OsiBrands,
        ...
        [Description("Page4 (f3d7)")] Page4Brands,
        ...
        [Description("Pandora (e7da)")] PandoraBrands,
        ...
        [Description("Pentagon (e790, 5, five, pentagon, shape)")] PentagonSolid,
        ...
        [Description("People Arrows (e068, conversation, discussion, distance, insert, isolation, separate, social distancing, talk, talking, together, uer, users-people)")] PeopleArrowsSolid,
        ...
        [Description("Person Drowning (e545, drown, emergency, swim)")] PersonDrowningSolid,
        ...
        [Description("Phone Volume (f2a0, call, earphone, number, ring, ringing, sound, support, talking, telephone, voice, volume-control-phone)")] PhoneVolumeSolid,
        [Description("Photo Film (f87c, av, film, image, library, media)")] PhotoFilmSolid,
        [Description("Php (f457)")] PhpBrands,
        [Description("Pied Piper Alt (f1a8)")] PiedPiperAltBrands,
        [Description("Pied Piper (f2ae)")] PiedPiperBrands,
        [Description("Pied Piper Hat (f4e5, clothing)")] PiedPiperHatBrands,
        [Description("Pied Piper Pp (f1a7)")] PiedPiperPpBrands,
        ...
        [Description("Pixelfed (e7db)")] PixelfedBrands,
        ...
        [Description("Qrcode (f029, barcode, info, information, qr, qr-code, scan)")] QrcodeSolid,
        ...
        [Description("Rebel (f1d0)")] RebelBrands,
        ...
        [Description("Rev (f5b2)")] RevBrands,
        ...
        [Description("Rocketchat (f3e8)")] RocketchatBrands,
        ...
        [Description("Septagon (e820, 7, heptagon, seven, shape)")] SeptagonSolid,
        ...
        [Description("Shirtsinbulk (f214)")] ShirtsinbulkBrands,
        ...
        [Description("Shop Slash (e070, building, buy, closed, disabled, purchase, shopping)")] ShopSlashSolid,
        ...
        [Description("Single Quote Left (e81b, left single quotation mark, mention, note, phrase, text, type)")] SingleQuoteLeftSolid,
        [Description("Single Quote Right (e81c, mention, note, phrase, right single quotation mark, text, type)")] SingleQuoteRightSolid,
        ...
        [Description("Slack (f198, anchor, hash, hashtag)")] SlackBrands,
        ...
        [Description("Spiral (e80a, design, dizzy, rotate, spin, swirl, twist)")] SpiralSolid,
        ...
        [Description("Square Binary (e69b, ai, data, language, llm, model, programming, token)")] SquareBinarySolid,
        [Description("Square Bluesky (e6a3, social network)")] SquareBlueskyBrands,
        ...
        [Description("Square Figma (e7e4)")] SquareFigmaBrands,
        [Description("Square Font Awesome (e5ad)")] SquareFontAwesomeBrands,
        [Description("Square Font Awesome Stroke (f35c, awesome, flag, font, icons, typeface)")] SquareFontAwesomeStrokeBrands,
        ...
        [Description("Square Linkedin (e7d0)")] SquareLinkedinBrands,
        ...
        [Description("Square Pied Piper (e01e)")] SquarePiedPiperBrands,
        ...
        [Description("Square Snapchat (f2ad)")] SquareSnapchatBrands,
        ...
        [Description("Square Threads (e619, social network)")] SquareThreadsBrands,
        ...
        [Description("Square Web Awesome (e683, awesome, coding, components, crown, web)")] SquareWebAwesomeBrands,
        [Description("Square Web Awesome Stroke (e684, awesome, coding, components, crown, web)")] SquareWebAwesomeStrokeBrands,
        ...
        [Description("Square X Twitter (e61a, elon, twitter, x)")] SquareXTwitterBrands,
        ...
        [Description("Store Slash (e071, building, buy, closed, disabled, purchase, shopping)")] StoreSlashSolid,
        ...
        [Description("Studiovinari (f3f8)")] StudiovinariBrands,
        [Description("Stumbleupon (f1a4)")] StumbleuponBrands,
        ...
        [Description("Table Cells Column Lock (e678, blocks, boxes, category, column, excel, grid, lock, spreadsheet, squares)")] TableCellsColumnLockSolid,
        [Description("Table Cells Large (f009, blocks, boxes, category, excel, grid, spreadsheet, squares)")] TableCellsLargeSolid,
        [Description("Table Cells Row Lock (e67a, blocks, boxes, category, column, column, excel, grid, lock, lock, spreadsheet, squares)")] TableCellsRowLockSolid,
        [Description("Table Cells Row Unlock (e691, blocks, boxes, category, column, column, excel, grid, lock, lock, spreadsheet, squares, unlock)")] TableCellsRowUnlockSolid,
        [Description("Table Cells (f00a, blocks, boxes, category, excel, grid, spreadsheet, squares)")] TableCellsSolid,
        ...
        [Description("Tent Arrow Down To Line (e57e, bivouac, campground, campsite, permanent, refugee, refugee, shelter, shelter, tent)")] TentArrowDownToLineSolid,
        [Description("Tent Arrow Left Right (e57f, bivouac, campground, campsite, refugee, refugee, shelter, shelter, tent, transition)")] TentArrowLeftRightSolid,
        [Description("Tent Arrows Down (e581, bivouac, campground, campsite, insert, refugee, refugee, shelter, shelter, spontaneous, tent)")] TentArrowsDownSolid,
        [Description("Tent Arrow Turn Left (e580, bivouac, campground, campsite, refugee, refugee, shelter, shelter, temporary, tent)")] TentArrowTurnLeftSolid,
        [Description("Tent (e57d, bivouac, campground, campsite, refugee, shelter, tent)")] TentSolid,
        [Description("Tents (e582, bivouac, bivouac, campground, campground, campsite, refugee, refugee, shelter, shelter, tent, tent)")] TentsSolid,
        [Description("Terminal (f120, code, coding, command, console, development, prompt, terminal)")] TerminalSolid,
        [Description("Tex (e7ff, latex)")] TexBrands,
        ...
        [Description("Threads (e618, social network)")] ThreadsBrands,
        ...
        [Description("Thumbtack Slash (e68f, Black Pushpin, coordinates, location, marker, pin, pushpin, thumb-tack, unpin)")] ThumbtackSlashSolid,
        ...
        [Description("Tidal (e7dc)")] TidalBrands,
        ...
        [Description("Tower Broadcast (f519, airwaves, antenna, communication, emergency, radio, reception, signal, waves)")] TowerBroadcastSolid,
        [Description("Tower Cell (e585, airwaves, antenna, communication, radio, reception, signal, waves)")] TowerCellSolid,
        ...
        [Description("Traffic Light (f637, direction, go, light, road, signal, slow, stop, traffic, travel, vertical traffic light)")] TrafficLightSolid,
        ...
        [Description("Truck (f0d1, Black Truck, cargo, delivery, delivery truck, shipping, truck, vehicle)")] TruckRegular,
        ...
        [Description("Uncharted (e084)")] UnchartedBrands,
        ...
        [Description("Unity (e049)")] UnityBrands,
        ...
        [Description("Up Right And Down Left From Center (f424, arrows, bigger, enlarge, expand, fullscreen, maximize, resize, resize, scale, size)")] UpRightAndDownLeftFromCenterSolid,
        ...
        [Description("User Plus (f234, add, avatar, employee, follow, positive, sign up, signup, team, user)")] UserPlusSolid,
        ...
        [Description("User Shield (f505, employee, protect, safety, security, uer)")] UserShieldSolid,
        ...
        [Description("Usps (f7e1, american, package, shipping, usa)")] UspsBrands,
        [Description("Ussunnah (f407)")] UssunnahBrands,
        ...
        [Description("Van Shuttle (f5b6, airport, bus, minibus, public-transportation, transportation, travel, vehicle)")] VanShuttleSolid,
        ...
        [Description("Vimeo V (f27d, vimeo)")] VimeoVBrands,
        ...
        [Description("Vsco (e7dd)")] VscoBrands,
        [Description("V (56, Latin Capital Letter V, Latin Small Letter V, letter)")] VSolid,
        [Description("Vuejs (f41f)")] VuejsBrands,
        [Description("W3c (e7de)")] W3cBrands,
        ...
        [Description("Web Awesome (e682, awesome, coding, components, crown, web)")] WebAwesomeBrands,
        [Description("Web Awesome (e682, awesome, coding, components, crown, web)")] WebAwesomeSolid,
        ...
        [Description("Weixin (f1d7)")] WeixinBrands,
        [Description("Whatsapp (f232)")] WhatsappBrands,
        ...
        [Description("Wordpress (f19a)")] WordpressBrands,
        ...
        [Description("Yahoo (f19e)")] YahooBrands,
