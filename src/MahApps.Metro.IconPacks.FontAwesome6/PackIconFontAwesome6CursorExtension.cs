...
namespace MahApps.Metro.IconPacks
{
    ...
    public class FontAwesome6CursorExtension : FontAwesome6ImageExtension, IPackIconCursorExtension
    {
        public FontAwesome6CursorExtension() : base() => base.Brush = PackIconCursorHelper.DefaultBrush;
        public FontAwesome6CursorExtension(PackIconFontAwesome6Kind kind) : base(kind) => base.Brush = PackIconCursorHelper.DefaultBrush;
