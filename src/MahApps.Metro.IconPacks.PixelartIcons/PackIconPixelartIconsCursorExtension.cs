...
namespace MahApps.Metro.IconPacks
{
    ...
    public class PixelartIconsCursorExtension : PixelartIconsImageExtension, IPackIconCursorExtension
    {
        public PixelartIconsCursorExtension() : base() => base.Brush = PackIconCursorHelper.DefaultBrush;
        public PixelartIconsCursorExtension(PackIconPixelartIconsKind kind) : base(kind) => base.Brush = PackIconCursorHelper.DefaultBrush;
