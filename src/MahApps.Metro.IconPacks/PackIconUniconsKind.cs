namespace MahApps.Metro.IconPacks
{
    ...
    public enum PackIconUniconsKind
    {
        ...
        [Description("atm-card (Business, credit-card, debit-card, card, atm-card)")] AtmCard,
        ...
        [Description("ball (Sports, pingpong, table-tennis, racket, ball)")] Ball,
        ...
        [Description("bars (Content, justify, align, alignment, bars)")] Bars,
        ...
        [Description("bell-slash (User Interface, no-bell, no-notification, block-notification, forbidden-notification, bell-slash)")] BellSlash,
        [Description("bill (Business, invoice, payment, dollar, bill-payment, money, receipt, bill)")] Bill,
        [Description("bitcoin (Business, bit-coin, bitcoin-sign, bitcoin)")] Bitcoin,
        ...
        [Description("box (User Interface, cube, box)")] Box,
        ...
        [Description("calcualtor (User Interface, calculation, device, calcualtor)")] Calcualtor,
        ...
        [Description("camera (Multimedia, photo, photoshut, media, multimedia, camera)")] Camera,
        ...
        [Description("card-atm (User Interface, atm-card, credit-card, debit-card, visa-card, card-atm)")] CardAtm,
        ...
        [Description("cart (Shopping, shopping-bag, bag, online-shopping, cart)")] Cart,
        ...
        [Description("chat (Chat, comment, chat-bubble, chat)")] Chat,
        [Description("chat-bubble-user (Chat, comment, account, user, chat-bubble, user-chat, chat-bubble-user)")] ChatBubbleUser,
        [Description("chat-info (Chat, chat-information, comment, chatting, chat, chat-info)")] ChatInfo,
        ...
        [Description("clipboard (File And Folder, blank-clipboard, clipboard)")] Clipboard,
        ...
        [Description("clipboard-blank (File And Folder, clipboard, clipboard-blank)")] ClipboardBlank,
        ...
        [Description("cloud-computing (Cloud And Web, cloud-connection, cloud-network, connection, data-connection, cloud-data-connection, cloud-computing)")] CloudComputing,
        ...
        [Description("cloud-set (Weather, cloud, sea, ocean, wind, cloud-set)")] CloudSet,
        ...
        [Description("code (Arrows, arrow, navigation, code)")] Code,
        [Description("coffee (User Interface, cup, mug, tea, drink, beverage, coffee)")] Coffee,
        [Description("cog (User Interface, setting, gear, cogwheel, cog)")] Cog,
        ...
        [Description("comment (Chat, chat, chat-bubble, chatting, communication, comment)")] Comment,
        [Description("comment-alt (Chat, chat-bubble, chat, chatting, communication, comment, comment-alt)")] CommentAlt,
        [Description("comment-alt-block (Chat, block-chat, block-message, chat, communication, chat-bubble, comment-alt-block)")] CommentAltBlock,
        ...
        [Description("comment-alt-check (Chat, approve-chat, chat-approve, success-chat, chat-bubble, tickmark, comment-alt-check)")] CommentAltCheck,
        [Description("comment-alt-dots (Chat, comment, chat-bubble, chat, chatting, communication, comment-alt-dots)")] CommentAltDots,
        [Description("comment-alt-download (Chat, download-chat-bubble, chat-download, chat, chat-bubble, download, comment-alt-download)")] CommentAltDownload,
        [Description("comment-alt-edit (Chat, edit-chat-bubble, edit-message, edit-chat, chat, chat-bubble, comment-alt-edit)")] CommentAltEdit,
        [Description("comment-alt-exclamation (Chat, chat-info, chat-information, comment, chat-bubble, comment-alt-exclamation)")] CommentAltExclamation,
        ...
        [Description("comment-alt-info (Chat, chat-info, chat-information, comment, chat, bubble, comment-alt-info)")] CommentAltInfo,
        ...
        [Description("comment-alt-lock (Chat, lock-chat-bubble, secure-chat, secure-chatting, chat-bubble, chat, comment-alt-lock)")] CommentAltLock,
        [Description("comment-alt-medical (Chat, medical-chat, medical-contact, chat, conversion, bubble, comment-alt-medical)")] CommentAltMedical,
        [Description("comment-alt-message (Chat, chat-bubble, chat, chatting, communication, comment-alt-message)")] CommentAltMessage,
        [Description("comment-alt-notes (Chat, chat, chatting, comment, bubble, message, conversation, comment-alt-notes)")] CommentAltNotes,
        [Description("comment-alt-plus (Chat, add-chat-bubble, new-chat, chat, chatting, communication, comment-alt-plus)")] CommentAltPlus,
        [Description("comment-alt-question (Chat, question-mark-chat-bubble, chat, chat-bubble, help-chat, support-chat, comment-alt-question)")] CommentAltQuestion,
        [Description("comment-alt-redo (Chat, reload-chat, refresh-chat, chat, chat-bubble, refresh, reload, chat-sync, comment-alt-redo)")] CommentAltRedo,
        ...
        [Description("comment-alt-share (Chat, share-chat-bubble, chat, chat-bubble, share-chat, share, comment-alt-share)")] CommentAltShare,
        [Description("comment-alt-shield (Chat, shield-chat-bubble, secure-chat, protected-chat, chat-bubble, chat, comment-alt-shield)")] CommentAltShield,
        ...
        [Description("comment-alt-upload (Chat, upload-chat-bubble, chat, chat-bubble, upload, comment-alt-upload)")] CommentAltUpload,
        [Description("comment-alt-verify (Chat, approve-chat, chat-approve, success-chat, chat-bubble, tick-mark, comment-alt-verify)")] CommentAltVerify,
        [Description("comment-block (Chat, block-chat, block-message, chat, communication, block-chat-bubble, chat-bubble, comment-block)")] CommentBlock,
        ...
        [Description("comment-check (Chat, approve-chat, chat-approve, success-chat, chat-bubble, tick, comment-check)")] CommentCheck,
        [Description("comment-dots (Chat, chat, chatting, comment, message, conversation, comment-dots)")] CommentDots,
        [Description("comment-download (Chat, download-chat-bubble, chat-download, chat, chat-bubble, download, comment-download)")] CommentDownload,
        [Description("comment-edit (Chat, edit-chat-bubble, edit-message, edit-chat, chat, chat-bubble, comment-edit)")] CommentEdit,
        [Description("comment-exclamation (Chat, chat-info, chat-information, comment, chat, comment-exclamation)")] CommentExclamation,
        ...
        [Description("comment-info (Chat, chat-info, chat-information, comment, chat-bubble, chat, comment-info)")] CommentInfo,
        [Description("comment-info-alt (Chat, chat-info, chat-information, comment, chat, comment-info-alt)")] CommentInfoAlt,
        [Description("comment-lines (Chat, chat, chatting, comment, chat-bubble, message, conversation, comment-lines)")] CommentLines,
        [Description("comment-lock (Chat, lock-chat-bubble, secure-chat, secure-chatting, chat-bubble, chat, comment-lock)")] CommentLock,
        [Description("comment-medical (Chat, medical-chat, medical-contact, chat, conversion, chat-bubble, comment-medical)")] CommentMedical,
        [Description("comment-message (Chat, chat-bubble, chat, chatting, communication, comment-message)")] CommentMessage,
        [Description("comment-notes (Chat, chat, chatting, comment, chat-bubble, message, conversation, comment-notes)")] CommentNotes,
        [Description("comment-plus (Chat, add-chat, new-chat, chat, chatting, communication, comment-plus)")] CommentPlus,
        [Description("comment-question (Chat, question-mark-chat-bubble, chat, chat-bubble, help-chat, support-chat, comment-question)")] CommentQuestion,
        [Description("comment-redo (Chat, reload-chat, refresh-chat, chat, chat-bubble, refresh, reload, chat-sync, comment-redo)")] CommentRedo,
        ...
        [Description("comment-search (Chat, search-chat, search-message, find-chat, find-message, search-chat-bubble, chat, comment-search)")] CommentSearch,
        [Description("comment-share (Chat, share-chat-bubble, chat, chat-bubble, share-chat, share, comment-share)")] CommentShare,
        [Description("comment-shield (Chat, shield-chat-bubble, secure-chat, protected-chat, chat, bubble, comment-shield)")] CommentShield,
        [Description("comment-slash (User Interface, no-message, no-chat, no-chat-bubble, no-communication, comment-slash)")] CommentSlash,
        [Description("comment-upload (Chat, upload-chat-bubble, chatting, chat, chat-bubble, upload, comment-upload)")] CommentUpload,
        [Description("comment-verify (Chat, approve-chat, chat-approve, success-chat, chat-bubble, tick-mark, comment-verify)")] CommentVerify,
        ...
        [Description("compress-v (Design Tools, vertical-minimize, minimize, resize, shrink, compress-v)")] CompressV,
        [Description("computer-mouse (Devices, mouse, computer-hardware, hardware, computer-mouse)")] ComputerMouse,
        ...
        [Description("creative-commons-pd-alt (Sign And Symbol, no-creative-commons, no-creative-commons-symbol, sign, symbol, creative-commons-pd-alt)")] CreativeCommonsPdAlt,
        ...
        [Description("cube (User Interface, box, square, cube)")] Cube,
        ...
        [Description("document (File And Folder, document-info, file-info, document-information, file-details, document)")] Document,
        ...
        [Description("down-arrow (Arrows, download, downloading, down-arrow)")] DownArrow,
        ...
        [Description("entry (User Interface, sign-in, login, entry)")] Entry,
        ...
        [Description("exit (User Interface, sign-out, logout, exit)")] Exit,
        ...
        [Description("food (User Interface, pizza-slice, slice, pizza, fast-food, junk-food, food)")] Food,
        ...
        [Description("game (Sports, tennis-ball, ball, sport, game)")] Game,
        ...
        [Description("glass-tea (User Interface, tea-glass, tea-cup, glass, glass-tea)")] GlassTea,
        ...
        [Description("google-drive (Brand Logos, social-media, logo, brand, drive, google-drive)")] GoogleDrive,
        [Description("graduation-hat (Education, mortarboard, graduation-cap, graduate, cap, hat, graduation-hat)")] GraduationHat,
        ...
        [Description("info-circle (User Interface, exclamation-mark, alert, wrong, info-circle)")] InfoCircle,
        ...
        [Description("location (Users, user-location, location-point, location-marker, location)")] Location,
        ...
        [Description("medical (Medical, bandage, band-aid, first-aid, healthcare, medical)")] Medical,
        ...
        [Description("mobey-bill-slash (User Interface, no-money, no-currency, no-notes, block-money, block-notes, no-cash, mobey-bill-slash)")] MobeyBillSlash,
        ...
        [Description("mouse (Devices, computer-mouse, input-device, hardware, mouse)")] Mouse,
        ...
        [Description("pentagon (Shape, shape, pentagon)")] Pentagon,
        ...
        [Description("plus-square (User Interface, plus-square)")] PlusSquare,
        [Description("podium (Education, speaker, public-speaker, stage, podium)")] Podium,
        [Description("polygon (Shape, shape, polygon)")] Polygon,
        ...
        [Description("schedule (Business, calender, planner, schedule)")] Schedule,
        [Description("science (Education, brain, human-brain, human-mind, mind, science)")] Science,
        ...
        [Description("shopping-trolley (Shopping, cart, bag, shopping-cart, online-shopping, shopping, shopping-trolley)")] ShoppingTrolley,
        ...
        [Description("sign-in-alt (User Interface, sign-in, login, entry, sign-in-alt)")] SignInAlt,
        [Description("sign-left (Location And Map, direction-board, sign-board, sig, guidepost, guide, sign-left)")] SignLeft,
        [Description("sign-out-alt (User Interface, sign-out, logout, exit, sign-out-alt)")] SignOutAlt,
        ...
        [Description("slack (Brand Logos, logo, social-media, brand, slack)")] Slack,
        ...
        [Description("sport (Sports, golf-ball, golf, game, sport)")] Sport,
        [Description("square (Shape, shape, square)")] Square,
        [Description("square-full (Design Tools, uncheck, check-box, box, square, square-full)")] SquareFull,
        [Description("square-shape (Shape, shape, square, square-shape)")] SquareShape,
        ...
        [Description("symbol (Sign And Symbol, p-sign, sign, public-domain-circle, symbol)")] Symbol,
        ...
        [Description("technology (Communication, laptop-connection, connection, laptop, data-sharing, device, technology)")] Technology,
        ...
        [Description("triangle (Shape, shape, triangle)")] Triangle,
        ...
        [Description("truck-case (Transport, luggage, luggage-trolley, hand-truck, truck-case)")] TruckCase,
        ...
        [Description("user-hard-hat (Construction, construction-helmet, construction-hard-hat, construction-hat, hard-hat, worker, user-hard-hat)")] UserHardHat,
        ...
        [Description("water-drop-slash (User Interface, no-water-drop, no-water, block-water, no-drop, water-drop-slash)")] WaterDropSlash,
        ...
        [Description("whatsapp (Brand Logos, logo, social-media, brand, whatsapp)")] Whatsapp,
        ...
        [Description("window-restore (Cloud And Web, multiple-tab, tab, web, web-page, browser, window-restore)")] WindowRestore,
        ...
        [Description("yellow (User Interface, traffic-signal, traffic-light, traffic, signal-light, light, red, green, yellow)")] Yellow,
