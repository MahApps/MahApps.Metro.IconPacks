...
namespace MahApps.Metro.IconPacks
{
    ...
    public class IoniconsCursorExtension : IoniconsImageExtension, IPackIconCursorExtension
    {
        public IoniconsCursorExtension() : base() => base.Brush = PackIconCursorHelper.DefaultBrush;
        public IoniconsCursorExtension(PackIconIoniconsKind kind) : base(kind) => base.Brush = PackIconCursorHelper.DefaultBrush;
