...
namespace MahApps.Metro.IconPacks
{
    ...
    public class RadixIconsCursorExtension : RadixIconsImageExtension, IPackIconCursorExtension
    {
        public RadixIconsCursorExtension() : base() => base.Brush = PackIconCursorHelper.DefaultBrush;
        public RadixIconsCursorExtension(PackIconRadixIconsKind kind) : base(kind) => base.Brush = PackIconCursorHelper.DefaultBrush;
