...
namespace MahApps.Metro.IconPacks
{
    ...
    public class EvaIconsCursorExtension : EvaIconsImageExtension, IPackIconCursorExtension
    {
        public EvaIconsCursorExtension() : base() => base.Brush = PackIconCursorHelper.DefaultBrush;
        public EvaIconsCursorExtension(PackIconEvaIconsKind kind) : base(kind) => base.Brush = PackIconCursorHelper.DefaultBrush;
