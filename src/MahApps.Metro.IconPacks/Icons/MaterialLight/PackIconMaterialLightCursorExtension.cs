...
namespace MahApps.Metro.IconPacks
{
    ...
    public class MaterialLightCursorExtension : MaterialLightImageExtension, IPackIconCursorExtension
    {
        public MaterialLightCursorExtension() : base() => base.Brush = PackIconCursorHelper.DefaultBrush;
        public MaterialLightCursorExtension(PackIconMaterialLightKind kind) : base(kind) => base.Brush = PackIconCursorHelper.DefaultBrush;
