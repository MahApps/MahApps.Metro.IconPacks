...
namespace MahApps.Metro.IconPacks
{
    ...
    public class WeatherIconsCursorExtension : WeatherIconsImageExtension, IPackIconCursorExtension
    {
        public WeatherIconsCursorExtension() : base() => base.Brush = PackIconCursorHelper.DefaultBrush;
        public WeatherIconsCursorExtension(PackIconWeatherIconsKind kind) : base(kind) => base.Brush = PackIconCursorHelper.DefaultBrush;
