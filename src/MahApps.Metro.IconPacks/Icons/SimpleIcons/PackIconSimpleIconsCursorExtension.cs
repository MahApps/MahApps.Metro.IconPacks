...
namespace MahApps.Metro.IconPacks
{
    ...
    public class SimpleIconsCursorExtension : SimpleIconsImageExtension, IPackIconCursorExtension
    {
        public SimpleIconsCursorExtension() : base() => base.Brush = PackIconCursorHelper.DefaultBrush;
        public SimpleIconsCursorExtension(PackIconSimpleIconsKind kind) : base(kind) => base.Brush = PackIconCursorHelper.DefaultBrush;
