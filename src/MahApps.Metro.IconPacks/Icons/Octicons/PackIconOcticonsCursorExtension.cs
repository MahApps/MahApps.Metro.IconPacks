...
namespace MahApps.Metro.IconPacks
{
    ...
    public class OcticonsCursorExtension : OcticonsImageExtension, IPackIconCursorExtension
    {
        public OcticonsCursorExtension() : base() => base.Brush = PackIconCursorHelper.DefaultBrush;
        public OcticonsCursorExtension(PackIconOcticonsKind kind) : base(kind) => base.Brush = PackIconCursorHelper.DefaultBrush;
