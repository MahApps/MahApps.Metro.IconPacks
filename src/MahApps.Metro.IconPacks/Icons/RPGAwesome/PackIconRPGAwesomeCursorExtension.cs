...
namespace MahApps.Metro.IconPacks
{
    ...
    public class RPGAwesomeCursorExtension : RPGAwesomeImageExtension, IPackIconCursorExtension
    {
        public RPGAwesomeCursorExtension() : base() => base.Brush = PackIconCursorHelper.DefaultBrush;
        public RPGAwesomeCursorExtension(PackIconRPGAwesomeKind kind) : base(kind) => base.Brush = PackIconCursorHelper.DefaultBrush;
