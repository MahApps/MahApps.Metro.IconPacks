...
namespace MahApps.Metro.IconPacks
{
    ...
    public class ZondiconsCursorExtension : ZondiconsImageExtension, IPackIconCursorExtension
    {
        public ZondiconsCursorExtension() : base() => base.Brush = PackIconCursorHelper.DefaultBrush;
        public ZondiconsCursorExtension(PackIconZondiconsKind kind) : base(kind) => base.Brush = PackIconCursorHelper.DefaultBrush;
