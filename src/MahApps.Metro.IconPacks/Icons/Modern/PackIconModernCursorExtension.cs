...
namespace MahApps.Metro.IconPacks
{
    ...
    public class ModernCursorExtension : ModernImageExtension, IPackIconCursorExtension
    {
        public ModernCursorExtension() : base() => base.Brush = PackIconCursorHelper.DefaultBrush;
        public ModernCursorExtension(PackIconModernKind kind) : base(kind) => base.Brush = PackIconCursorHelper.DefaultBrush;
