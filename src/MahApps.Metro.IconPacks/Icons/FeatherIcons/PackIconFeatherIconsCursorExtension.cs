...
namespace MahApps.Metro.IconPacks
{
    ...
    public class FeatherIconsCursorExtension : FeatherIconsImageExtension, IPackIconCursorExtension
    {
        public FeatherIconsCursorExtension() : base() => base.Brush = PackIconCursorHelper.DefaultBrush;
        public FeatherIconsCursorExtension(PackIconFeatherIconsKind kind) : base(kind) => base.Brush = PackIconCursorHelper.DefaultBrush;
