...
namespace MahApps.Metro.IconPacks
{
    ...
    public class EntypoCursorExtension : EntypoImageExtension, IPackIconCursorExtension
    {
        public EntypoCursorExtension() : base() => base.Brush = PackIconCursorHelper.DefaultBrush;
        public EntypoCursorExtension(PackIconEntypoKind kind) : base(kind) => base.Brush = PackIconCursorHelper.DefaultBrush;
