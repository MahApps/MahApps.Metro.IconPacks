...
namespace MahApps.Metro.IconPacks
{
    ...
    public class MaterialCursorExtension : MaterialImageExtension, IPackIconCursorExtension
    {
        public MaterialCursorExtension() : base() => base.Brush = PackIconCursorHelper.DefaultBrush;
        public MaterialCursorExtension(PackIconMaterialKind kind) : base(kind) => base.Brush = PackIconCursorHelper.DefaultBrush;
