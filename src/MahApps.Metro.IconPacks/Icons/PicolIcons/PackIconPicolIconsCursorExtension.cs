...
namespace MahApps.Metro.IconPacks
{
    ...
    public class PicolIconsCursorExtension : PicolIconsImageExtension, IPackIconCursorExtension
    {
        public PicolIconsCursorExtension() : base() => base.Brush = PackIconCursorHelper.DefaultBrush;
        public PicolIconsCursorExtension(PackIconPicolIconsKind kind) : base(kind) => base.Brush = PackIconCursorHelper.DefaultBrush;
