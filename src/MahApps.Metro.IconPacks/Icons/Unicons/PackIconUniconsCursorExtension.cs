...
namespace MahApps.Metro.IconPacks
{
    ...
    public class UniconsCursorExtension : UniconsImageExtension, IPackIconCursorExtension
    {
        public UniconsCursorExtension() : base() => base.Brush = PackIconCursorHelper.DefaultBrush;
        public UniconsCursorExtension(PackIconUniconsKind kind) : base(kind) => base.Brush = PackIconCursorHelper.DefaultBrush;
