...
namespace MahApps.Metro.IconPacks
{
    ...
    public class FontAwesomeCursorExtension : FontAwesomeImageExtension, IPackIconCursorExtension
    {
        public FontAwesomeCursorExtension() : base() => base.Brush = PackIconCursorHelper.DefaultBrush;
        public FontAwesomeCursorExtension(PackIconFontAwesomeKind kind) : base(kind) => base.Brush = PackIconCursorHelper.DefaultBrush;
