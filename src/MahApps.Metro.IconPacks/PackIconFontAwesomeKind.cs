namespace MahApps.Metro.IconPacks
{
    ...
    public enum PackIconFontAwesomeKind
    {
        ...
        [Description("ambulance (f0f9, emergency, emt, er, help, hospital, support, vehicle)")] AmbulanceSolid,
        ...
        [Description("Atom (f5d2, atheism, chemistry, ion, nuclear, science)")] AtomSolid,
        ...
        [Description("Bed (f236, lodging, rest, sleep, travel)")] BedSolid,
        ...
        [Description("Biohazard (f780, danger, dangerous, hazmat, medical, radioactive, toxic, waste, zombie)")] BiohazardSolid,
        ...
        [Description("Chess (f439, board, checkmate, game, strategy, tournament)")] ChessSolid,
        ...
        [Description("Gamepad (f11b, controller, d-pad, joystick, video)")] GamepadSolid,
        ...
        [Description("Hospital Symbol (f47e, clinic, emergency, map)")] HospitalSymbolSolid,
        ...
        [Description("Microscope (f610, electron, lens, optics, science, shrink)")] MicroscopeSolid,
        ...
        [Description("Sort Alpha Down (f15d, filter, order, sort-alpha-asc)")] SortAlphaDownSolid,
        [Description("Sort Alpha Up (f15e, filter, order, sort-alpha-desc)")] SortAlphaUpSolid,
        [Description("Sort Amount Down (f160, filter, order, sort-amount-asc)")] SortAmountDownSolid,
        [Description("Sort Amount Up (f161, filter, order, sort-amount-desc)")] SortAmountUpSolid,
        [Description("Sort Down (Descending) (f0dd, arrow, descending, filter, order, sort-desc)")] SortDownSolid,
        [Description("Sort Numeric Down (f162, filter, numbers, order, sort-numeric-asc)")] SortNumericDownSolid,
        [Description("Sort Numeric Up (f163, filter, numbers, order, sort-numeric-desc)")] SortNumericUpSolid,
        ...
        [Description("Stethoscope (f0f1, diagnosis, doctor, general practitioner, hospital, infirmary, medicine, office, outpatient)")] StethoscopeSolid,
        ...
        [Description("Syringe (f48e, doctor, immunizations, medical, needle)")] SyringeSolid,
        ...
        [Description("High Temperature (f769, cook, mercury, summer, thermometer, warm)")] TemperatureHighSolid,
        [Description("Low Temperature (f76b, cold, cool, mercury, thermometer, winter)")] TemperatureLowSolid,
        ...
        [Description("Torah (f6a0, book, jewish, judaism, religion)")] TorahSolid,
