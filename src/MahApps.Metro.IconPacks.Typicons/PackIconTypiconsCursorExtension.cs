...
namespace MahApps.Metro.IconPacks
{
    ...
    public class TypiconsCursorExtension : TypiconsImageExtension, IPackIconCursorExtension
    {
        public TypiconsCursorExtension() : base() => base.Brush = PackIconCursorHelper.DefaultBrush;
        public TypiconsCursorExtension(PackIconTypiconsKind kind) : base(kind) => base.Brush = PackIconCursorHelper.DefaultBrush;
