...
namespace MahApps.Metro.IconPacks
{
    ...
    public class FontAwesome5CursorExtension : FontAwesome5ImageExtension, IPackIconCursorExtension
    {
        public FontAwesome5CursorExtension() : base() => base.Brush = PackIconCursorHelper.DefaultBrush;
        public FontAwesome5CursorExtension(PackIconFontAwesome5Kind kind) : base(kind) => base.Brush = PackIconCursorHelper.DefaultBrush;
