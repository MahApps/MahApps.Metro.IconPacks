...
namespace MahApps.Metro.IconPacks
{
    ...
    public class FileIconsCursorExtension : FileIconsImageExtension, IPackIconCursorExtension
    {
        public FileIconsCursorExtension() : base() => base.Brush = PackIconCursorHelper.DefaultBrush;
        public FileIconsCursorExtension(PackIconFileIconsKind kind) : base(kind) => base.Brush = PackIconCursorHelper.DefaultBrush;
