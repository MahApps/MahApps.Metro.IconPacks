...
namespace MahApps.Metro.IconPacks
{
    ...
    public class FontaudioCursorExtension : FontaudioImageExtension, IPackIconCursorExtension
    {
        public FontaudioCursorExtension() : base() => base.Brush = PackIconCursorHelper.DefaultBrush;
        public FontaudioCursorExtension(PackIconFontaudioKind kind) : base(kind) => base.Brush = PackIconCursorHelper.DefaultBrush;
