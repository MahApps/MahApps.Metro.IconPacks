...
namespace MahApps.Metro.IconPacks
{
    ...
    public class VaadinIconsCursorExtension : VaadinIconsImageExtension, IPackIconCursorExtension
    {
        public VaadinIconsCursorExtension() : base() => base.Brush = PackIconCursorHelper.DefaultBrush;
        public VaadinIconsCursorExtension(PackIconVaadinIconsKind kind) : base(kind) => base.Brush = PackIconCursorHelper.DefaultBrush;
